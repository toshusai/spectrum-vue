<template>
  ...
  >
    ...
    {{ value1 }}
    <code-view
      :code="`&lt;sp-slider :min=&quot;0&quot; :max=&quot;1&quot; :value=&quot;value1&quot; @input=&quot;(v) =&gt; (value1 = v)&quot; /&gt;
{{ value1 }}`"
    ></code-view>
...
export default class SliderPage extends Vue {
  propData = [
    ...
    { prop: "valueText", type: "string", default: '""' },
    { prop: "ramp", type: "boolean", default: "false" },
    { prop: "label", type: "string", default: '""' },
    { prop: "value", type: "number", default: "0" },
    { prop: "step", type: "number", default: "0" },
    { prop: "min", type: "number", default: "0" },
    { prop: "max", type: "number", default: "0" },
    { prop: "offset", type: "number", default: "0" },
  ];
  slotData = [];
  eventData = [];
